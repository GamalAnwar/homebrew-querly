...
A [Homebrew](https://brew.sh) tap for [Querly](https://github.com/GamalAnwar/Querly) — a fast, native macOS database client for MySQL, PostgreSQL, and SQLite.

## Install

```bash
brew install --cask GamalAnwar/querly/querly
```

Or tap first, then install:

```bash
brew tap GamalAnwar/querly
